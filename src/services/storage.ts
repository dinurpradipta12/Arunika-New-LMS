...
const INITIAL_CONFIG: LMSConfig = {
  ...
  heroSubtitle:
    'Platform LMS profesional untuk masa depan yang lebih cerah dengan kurikulum terpadu.',
};
...
const INITIAL_COURSES: Course[] = [
  {
    ...
    description:
      'Pelajari dasar-dasar HTML, CSS, dan JavaScript dengan cara yang menyenangkan.',
    thumbnail:
      'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80',
    isPublic: true,
    createdAt: Date.now(),
    mentor: { ...DEFAULT_MENTOR },
    assets: [{ id: 'a1', name: 'Cheat Sheet HTML/CSS', type: 'link', url: '#' }],
    lessons: [
      {
        id: 'lesson-1-1',
      ...
      },
      {
        ...
        type: 'text',
        content:
          'Berikut adalah daftar tag dasar HTML yang harus Anda ketahui...',
        order: 1,
      },
    ],
  },
